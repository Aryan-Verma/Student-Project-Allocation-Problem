// This is a C++ implementation of Student-oriented Algorithm for Student-Project Allocation problem (SPA) from the research paper- 
...
vector<int> spa_student(vector<vector<int> > student, vector<vector<int> > lecturer, vector<int> lecturer_project, vector<vector<int> > student_preference, int proj_cap[], int lec_cap[]){
...
int main(){
	...
	vector<int> proj_assign = spa_student(student, lecturer, lecturer_project,student_preference, proj_cap, lec_cap);
